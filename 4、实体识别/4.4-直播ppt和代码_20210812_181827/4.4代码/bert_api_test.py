...
# 推理，查看bert输出
with torch.no_grad():
    last_hidden_state, pooled_output = bert_model(input_ids=batch_input_ids, attention_mask=batch_att_mask)
    print('last_hidden_state', last_hidden_state, last_hidden_state.shape)  # 可以接序列标注
    print('\n')
