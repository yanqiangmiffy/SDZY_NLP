...
trainer = BertCRFTrainer(
    ...
    loss_type='focal_loss', focal_loss_gamma=2, focal_loss_alpha=[1.] + [0.5] + [1.] * 14
)
trainer.train(
    train_texts, train_labels, validate_texts=dev_texts, validate_labels=dev_labels, batch_size=32, epoch=4
)
